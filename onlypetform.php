...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_result->num_rows === 0) {
        ...
        $sql = "INSERT INTO adoption_requests 
            ...
            family_agreement, caretaker, past_experience, pet_location, adoption_reason, alone_hours, diet, house_check, referral, additional_notes) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($sql);

        $stmt->bind_param(
            "ssssissssssssssissss",
            $email,
            $pre_adoption_check,
            $pet_name,
            $full_name,
...
<body>
    ...
    <div class="container1">
        <div class="container">
            ...
            <form action="dogadaptform.php" method="POST" id="donateform">
                <label>Email *</label>
