...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['cancel_all'])) {
        ...
        $delete_query = "DELETE FROM adoption_requests WHERE email='$email'";
        ...
        $delete_query = "DELETE FROM adoption_requests WHERE email='$email' AND adoption_date='$cancel_date'";
        if (mysqli_query($conn, $delete_query)) {
        ...
        echo "<script>alert('Invalid request.'); window.location.href='cancel_adoption.php?email=$email';</script>";
    }
} elseif (isset($_GET['email'])) {
    $email = mysqli_real_escape_string($conn, $_GET['email']);

    // Fetch all bookings for the given email
    $query = "SELECT * FROM adoption_requests WHERE email='$email' ORDER BY id ASC";
